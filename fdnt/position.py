...
from . import _fdnt
from ._fdnt import PositionD, PositionI
...
for Class in (_fdnt.PositionD, _fdnt.PositionI):
    ...
    For the float-valued position class, example initializations include:
        ...
        >>> pos = fdnt.PositionD(x=0.5, y=-0.5)
        >>> pos = fdnt.PositionD(0.5, -0.5)

    And for the integer-valued position class, example initializations include:

        >>> pos = fdnt.PositionI(x=45, y=13)
        >>> pos = fdnt.PositionI(45, 13)
