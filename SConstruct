...
WARNING: There seems to be a mismatch between this C++ compiler and the one
         ...
         This should not affect normal usage of FDNT.  However, exceptions
    ...
    if sys.platform.find('darwin') != -1:
        ...
        if (platform.mac_ver()[0] >= '10.7' and #xcode_version < '5.1' and
            ...
            if xcode_version < '5.1':
                ...
                print '         programs or modules that link to the BLAS library (such as FDNT).'
...
if unknown and not env['USE_UNKNOWN_VARS']:
    ...
    print 'that are not in the list of FDNT parameters given by scons -h)'
