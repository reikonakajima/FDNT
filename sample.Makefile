...
LIBS = -lm -L/opt/local/lib -lfftw3 -L/Users/reiko/2code/cfitsio/lib -lcfitsio -ltmv_symband $(TMV_LINK) -lCCfits

SUBOBJ = src/utilities2/BinomFact.o src/utilities2/Interpolant.o \
	src/utilities2/BinomFact.o src/utilities2/StringStuff.o \
	src/images/FITS.o src/images/Image.o src/images/FITSImage.o \
	src/utilities2/fft.o src/utilities2/GTable.o src/utilities2/Pset.o src/utilities2/Poly2d.o \
	src/astrometry2/PixelMap.o src/astrometry2/Astrometry.o src/astrometry2/PolyMap.o \
	src/astrometry2/PixelMapCollection.o

OBJ = src/Laguerre.o src/Shear.o src/LTransforms.o src/GLSimple.o src/SBProfile.o src/SBPixel.o \
